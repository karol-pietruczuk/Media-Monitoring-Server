...
export class Init1778844724290 implements MigrationInterface {
    name = 'Init1778844724290'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" int NOT NULL IDENTITY(1,1), "email" nvarchar(150) NOT NULL, "passwordHash" varchar(255) NOT NULL, "firstName" nvarchar(100) NOT NULL, "lastName" nvarchar(100) NOT NULL, "role" varchar(20) NOT NULL CONSTRAINT "DF_6620cd026ee2b231beac7cfe578" DEFAULT 'VIEWER', "isActive" bit NOT NULL CONSTRAINT "DF_fde2ce12ab12b02ae583dd76c7c" DEFAULT 1, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_e11e649824a45d8ed01d597fd93" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_80ca6e6ef65fb9ef34ea8c90f42" DEFAULT getdate(), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "totalDataChannelHistory" ("id" int NOT NULL IDENTITY(1,1), "totalDataChannelChangeType" nvarchar(30) NOT NULL, "totalDataChannelId" int NOT NULL, "totalDataChannelDataMappingInfo" nvarchar(120) NOT NULL, "totalDataChannelMeterId" int NOT NULL, "totalDataChannelDataSourceId" int NOT NULL, "totalDataChannelCreatedAt" datetime2 NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_6d62ae5d4a5b4158342b5b6c472" DEFAULT getdate(), CONSTRAINT "PK_1827bd045643dd05e885b49329a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "dataSource" ("id" int NOT NULL IDENTITY(1,1), "protocol" nvarchar(30) NOT NULL, "connectionInfo" nvarchar(120) NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_edf3f07a01e6cceb0a55b0d85e5" DEFAULT getdate(), CONSTRAINT "PK_6d01ae6c0f47baf4f8e37342268" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_DATA_SOURCE" ON "dataSource" ("id") `);
        await queryRunner.query(`CREATE TABLE "pulseDataChannel" ("id" int NOT NULL IDENTITY(1,1), "dataMappingInfo" nvarchar(120) NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_f5290628149a0a84edac7932b97" DEFAULT getdate(), "meterId" int, "dataSourceId" int, CONSTRAINT "PK_b8a3f6bfe61f26586b43fed2e9a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "totalDataChannel" ("id" int NOT NULL IDENTITY(1,1), "dataMappingInfo" nvarchar(120) NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_64d0ab131e112a937260b9327ea" DEFAULT getdate(), "meterId" int, "dataSourceId" int, CONSTRAINT "PK_766a741c75f32257736dbc49aac" PRIMARY KEY ("id"))`);
