...
export class Init1779450883315 implements MigrationInterface {
    name = 'Init1779450883315'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "dataSource" DROP COLUMN "connectionInfo"`);
        await queryRunner.query(`ALTER TABLE "dataSource" ADD "connectionInfo" nvarchar(max) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pulseDataChannel" ADD CONSTRAINT "FK_98d09dc65eb3ef3853a32848537" FOREIGN KEY ("meterId") REFERENCES "meter"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "dataSource" DROP COLUMN "connectionInfo"`);
        await queryRunner.query(`ALTER TABLE "dataSource" ADD "connectionInfo" nvarchar(120) NOT NULL`);
    }
