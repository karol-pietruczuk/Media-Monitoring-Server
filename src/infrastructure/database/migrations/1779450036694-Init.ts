...
export class Init1779450036694 implements MigrationInterface {
    name = 'Init1779450036694'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" int NOT NULL IDENTITY(1,1), "email" nvarchar(150) NOT NULL, "passwordHash" varchar(255) NOT NULL, "firstName" nvarchar(100) NOT NULL, "lastName" nvarchar(100) NOT NULL, "role" varchar(20) NOT NULL CONSTRAINT "DF_6620cd026ee2b231beac7cfe578" DEFAULT 0, "isActive" bit NOT NULL CONSTRAINT "DF_fde2ce12ab12b02ae583dd76c7c" DEFAULT 1, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_e11e649824a45d8ed01d597fd93" DEFAULT getdate(), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "UQ_users_email" ON "user" ("email") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_User" ON "user" ("id") `);
        await queryRunner.query(`CREATE TABLE "user_history" ("id" int NOT NULL IDENTITY(1,1), "userId" int NOT NULL, "changedById" int, "action" nvarchar(50) NOT NULL, "oldValues" nvarchar(MAX), "newValues" nvarchar(MAX), "comment" nvarchar(MAX), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_7a6eda3b72a6e17acc4792a6ce5" DEFAULT getdate(), CONSTRAINT "PK_777252b9045d8011ab83c5b0834" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_User_History" ON "user_history" ("id") `);
        await queryRunner.query(`CREATE TABLE "pulseDataCalculated" ("id" int NOT NULL IDENTITY(1,1), "pulsesAfterLastCalibration" bigint NOT NULL, "actualValue" numeric(17,4) NOT NULL, "actualTimestamp" datetime2 NOT NULL CONSTRAINT "DF_4fe9c6d8ed54e703203f96cefc6" DEFAULT getdate(), "meterId" int NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_aad5e30e89062936d58e7133f2e" DEFAULT getdate(), CONSTRAINT "UQ_28b858c26cb941a699e658d57f1" UNIQUE ("meterId"), CONSTRAINT "PK_d1fea62499bddd5a8110366d6d2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "pulseDataMultiplier" ("id" int NOT NULL IDENTITY(1,1), "value" numeric(15,10) NOT NULL, "expirationDateFrom" datetime2 NOT NULL, "expirationDateUntil" datetime2, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_a67d0766b0379616da572cf535d" DEFAULT getdate(), "meterId" int, "meterCalibrationStart" int, "meterCalibrationStop" int, CONSTRAINT "PK_f11d372a7474d153dd50e734411" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_PULSE_DATA_MULTIPLIER" ON "pulseDataMultiplier" ("id") `);
        await queryRunner.query(`CREATE TABLE "meterCalibration" ("id" int NOT NULL IDENTITY(1,1), "value" numeric(17,4) NOT NULL, "timestamp" datetime2 NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_af6fd62a36bfa9e73fa215a7b66" DEFAULT getdate(), "meterId" int, CONSTRAINT "PK_b172acc30b2f063dcae6d1ccc19" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_METER_CALIBRATION" ON "meterCalibration" ("id") `);
        await queryRunner.query(`CREATE TABLE "location" ("id" int NOT NULL IDENTITY(1,1), "mainLocation" nvarchar(50) NOT NULL, "subLocation" nvarchar(50), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_09dee1a3d42723079bd45577916" DEFAULT getdate(), CONSTRAINT "PK_876d7bdba03c72251ec4c2dc827" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_LOCATION" ON "location" ("id") `);
        await queryRunner.query(`CREATE TABLE "pulseDataMeasurement" ("id" int NOT NULL IDENTITY(1,1), "pulses" int NOT NULL, "timestamp" datetime2 NOT NULL CONSTRAINT "DF_6b2276e47623e9b6f045f61890d" DEFAULT getdate(), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_456bd2ea7b9e7b487edbbb69bf7" DEFAULT getdate(), "meterId" int, CONSTRAINT "PK_0761eacb870e9339e4da72b97a4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "dataSource" ("id" int NOT NULL IDENTITY(1,1), "protocol" nvarchar(30) NOT NULL, "connectionInfo" nvarchar(120) NOT NULL, "isActive" bit NOT NULL CONSTRAINT "DF_676628a351d88c39365d7f92889" DEFAULT 1, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_edf3f07a01e6cceb0a55b0d85e5" DEFAULT getdate(), CONSTRAINT "PK_6d01ae6c0f47baf4f8e37342268" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_DATA_SOURCE" ON "dataSource" ("id") `);
        await queryRunner.query(`CREATE TABLE "pulseDataChannel" ("id" int NOT NULL IDENTITY(1,1), "dataMappingInfo" nvarchar(MAX) NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_f5290628149a0a84edac7932b97" DEFAULT getdate(), "meterId" int, "dataSourceId" int, CONSTRAINT "PK_b8a3f6bfe61f26586b43fed2e9a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "totalDataMeasurement" ("id" int NOT NULL IDENTITY(1,1), "value" decimal(10,3) NOT NULL, "timestamp" datetime2 NOT NULL CONSTRAINT "DF_13de08c38aed01d2ed5bd11a1ec" DEFAULT getdate(), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_20470a2ba1b14677792eaa23e4c" DEFAULT getdate(), "meterId" int, CONSTRAINT "PK_6116e6bd47cc67acabfb439e338" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "meter" ("id" int NOT NULL, "name" nvarchar(50) NOT NULL, "symbol" nvarchar(50) NOT NULL, "unit" nvarchar(30) NOT NULL CONSTRAINT "DF_bb7d584d202e6a15b269bdffcc9" DEFAULT 'm³', "createdAt" datetime2 NOT NULL CONSTRAINT "DF_27faa9c3b0db1ee219b04db21ca" DEFAULT getdate(), "locationId" int, CONSTRAINT "PK_6a2a722edc5f966fa3562638f91" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_Meter" ON "meter" ("id") `);
        await queryRunner.query(`CREATE TABLE "totalDataChannel" ("id" int NOT NULL IDENTITY(1,1), "dataMappingInfo" nvarchar(MAX) NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_64d0ab131e112a937260b9327ea" DEFAULT getdate(), "meterId" int, "dataSourceId" int, CONSTRAINT "PK_766a741c75f32257736dbc49aac" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "totalDataChannelHistory" ("id" int NOT NULL IDENTITY(1,1), "totalDataChannelId" int NOT NULL, "changedById" int, "totalDataChannelChangeType" nvarchar(50) NOT NULL, "oldValues" nvarchar(MAX), "newValues" nvarchar(MAX), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_6d62ae5d4a5b4158342b5b6c472" DEFAULT getdate(), CONSTRAINT "PK_1827bd045643dd05e885b49329a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_TOTAL_DATA_CHANNEL_HISTORY" ON "totalDataChannelHistory" ("id") `);
        await queryRunner.query(`CREATE TABLE "pulseDataMultiplierHistory" ("id" int NOT NULL IDENTITY(1,1), "pulseDataMultiplierId" int NOT NULL, "changedById" int, "pulseDataMultiplierHistoryChange" nvarchar(50) NOT NULL, "oldValues" nvarchar(MAX), "newValues" nvarchar(MAX), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_8346f752c62174e2f1caa753bd7" DEFAULT getdate(), CONSTRAINT "PK_15b4b1c36cb9f4204434d663ff0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_PULSE_DATA_MULTIPLIER_HISTORY" ON "pulseDataMultiplierHistory" ("id") `);
        await queryRunner.query(`CREATE TABLE "pulseDataChannelHistory" ("id" int NOT NULL IDENTITY(1,1), "pulseDataChannelId" int NOT NULL, "changedById" int, "pulseDataChannelChange" nvarchar(50) NOT NULL, "oldValues" nvarchar(MAX), "newValues" nvarchar(MAX), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_aa8e6dbf84521b0c32ccc2be5ea" DEFAULT getdate(), CONSTRAINT "PK_475a14ec5a8899661ac6068bbfe" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_PULSE_DATA_CHANNEL_HISTORY" ON "pulseDataChannelHistory" ("id") `);
        await queryRunner.query(`CREATE TABLE "meterHistory" ("id" int NOT NULL IDENTITY(1,1), "meterId" int NOT NULL, "changedById" int, "meterChange" nvarchar(50) NOT NULL, "oldValues" nvarchar(MAX), "newValues" nvarchar(MAX), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_d9324442b475ac6627bb5076155" DEFAULT getdate(), CONSTRAINT "PK_88b7d82ae75e9157cb3f9075118" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "PK_METER_HISTORY" ON "meterHistory" ("id") `);
        await queryRunner.query(`CREATE TABLE "meterCalibrationHistory" ("id" int NOT NULL IDENTITY(1,1), "meterCalibrationId" int NOT NULL, "changedById" int, "meterCalibrationChangeType" nvarchar(50) NOT NULL, "oldValues" nvarchar(MAX), "newValues" nvarchar(MAX), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_c1a08da5722b2b997f9ac725303" DEFAULT getdate(), CONSTRAINT "PK_de6ff7332d05e2c7d38e617110b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "dataSourceHistory" ("id" int NOT NULL IDENTITY(1,1), "dataSourceId" int NOT NULL, "changedById" int, "dataSourceChange" nvarchar(50) NOT NULL, "oldValues" nvarchar(MAX), "newValues" nvarchar(MAX), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_128fccbbcc4db880fa7faef6cea" DEFAULT getdate(), CONSTRAINT "PK_e64d4508fdfe050740dee68529e" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "PK_User_History" ON "user_history"`);
        await queryRunner.query(`DROP TABLE "user_history"`);
        await queryRunner.query(`DROP INDEX "PK_User" ON "user"`);
